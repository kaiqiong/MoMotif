...
load("/Users/kaiqiongzhao/Documents/Projects_since_2021/WitcherKI/GADEM_top_1000/GADEM_up_1000.RData")
gadem_up <- gadem

load("/Users/kaiqiongzhao/Documents/Projects_since_2021/WitcherKI/GADEM_top_1000/GADEM_down_1000.RData")
...
load("/Users/kaiqiongzhao/Documents/Projects_since_2021/WitcherKI/GADEM_top_1000/GADEM_null_1000.RData")
gadem_null <- gadem
...
out.ranges<- readRDS("/Users/kaiqiongzhao/Documents/Projects_since_2021/WitcherKI/Results/out_ranges_June_28.rds")
...
pdf("Chi_square_p_vals_KI_Lost_Stable.pdf", height = 5, width = 8)
plot(-log10(pval_vec), pch = 19, xlab = "Position",
     ylab = "-log10(p-value)", 
...
pdf("Chi_square_p_vals_KI_Gained_Stable.pdf", height = 5, width = 8)
plot(-log10(pval_vec1), pch = 19, xlab = "Position",
...
write.csv(p_vals_KI, file="Chi_square_p_vals_KI.csv")
