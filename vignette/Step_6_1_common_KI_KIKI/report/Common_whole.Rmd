...
load("~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/GADEM_CommonGain.RData")
gadem_up <- gadem

load("~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/GADEM_CommonLost.RData")
...
load("~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/GADEM_CommonStable.RData")
gadem_null <- gadem
...
gr_null <- read.delim(file = "~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/CommonStable_All.txt" ) # 903
# 3- Extension based on Biostrings::getSeq


gr_down = read.delim(file = "~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/CommonLost_All.txt" ) # 986
gr_up = read.delim(file = "~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Data_whole/CommonGain_All.txt" ) # 894

Seqs_up=Biostrings::getSeq(Hsapiens, GRanges(gr_up) + 120 )
Seqs_down=Biostrings::getSeq(Hsapiens, GRanges(gr_down) + 500 )
Seqs_null=Biostrings::getSeq(Hsapiens, GRanges(gr_null) +500 )  
```
...
res_ext1 <- seq_set_extract(rr1, motif11, Seqs_up, bp.use = 61, reverse = FALSE, rrWidth = 13, start = 2, end = 14)
#-------
...
res_ext2 <- seq_set_extract(rr2, motif21, Seqs_down, bp.use = 61, reverse = FALSE, rrWidth = 13, start = 1, end = 13)
# Down cluster -- 16 bp, center is on position 8
res_ext3<- seq_set_extract(rr3, motif31, Seqs_null, bp.use = 61, reverse = TRUE, rrWidth = 13, start = 2, end = 14)
```
...
#write.csv(res_tab, "Common_all_freqTab_61bp.csv")
...
#setwd("~/Documents/Packages/diffMotif/vignette/Step_6_1_common_KI_KIKI/Results_whole")
#write.csv(p_vals_KI, file="Chi_square_p_vals_Common_all.csv")
